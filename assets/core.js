const MMM = (() => {
  ...
  function map(id) {
    ...
    L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png?key=cb1_3t49_1_7f9b7724d21015fef59521c3', { attribution:'&copy; OpenStreetMap &copy; CARTO' }).addTo(m);
    return m;
  }
